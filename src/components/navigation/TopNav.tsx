    ...
    <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-xl border-b border-slate-200/80 px-2 sm:px-4 py-2 shadow-xs">
      <div className="mx-auto flex w-full max-w-full sm:max-w-4xl items-center justify-between gap-2.5">
        <Link to="/" className="flex items-center gap-2 group cursor-pointer">
          <div className="h-8 sm:h-9 w-8 sm:w-9 rounded-xl bg-[#FFDE00] flex items-center justify-center font-black text-slate-950 text-sm shadow-xs">
          ...
          <div className="leading-tight">
            <p className="text-xs sm:text-base font-black tracking-tight text-slate-900">
              PARTIU <span className="text-amber-500 font-extrabold">BRASIL</span>
            </p>
        ...
        <nav className="flex items-center gap-2">
          ...
          <Link
            to="/app"
            className="min-h-[44px] h-11 flex items-center gap-1.5 rounded-xl bg-slate-950 hover:bg-slate-900 px-4 py-2 text-xs sm:text-sm font-black text-[#FFDE00] shadow-xs transition-all active:scale-95 cursor-pointer"
          >
            <span>Pedir Agora</span>
            <ArrowRight className="h-4 w-4 text-[#FFDE00]" />
          </Link>
        </nav>
      </div>
    </header>
