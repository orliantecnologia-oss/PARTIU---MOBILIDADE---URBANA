            ...
            <div className="flex-1 min-w-0 space-y-2">
              ...
              <div className="flex items-center justify-between gap-2">
                <input
                  ...
                  className={`w-full text-xs sm:text-[13px] font-semibold text-slate-800 bg-transparent placeholder:text-slate-400 truncate outline-none py-1 transition ${
                ...
                <div className="flex items-center gap-1 shrink-0">
                  {origemLocal && origemLocal !== "Meu Local Atual" && (
                    <button
                      ...
                      className="px-2 py-0.5 text-blue-600 hover:bg-blue-50 rounded-lg text-[10px] font-bold flex items-center gap-1 cursor-pointer transition"
                  ...
                  {origemLocal && (
                    <button
                      ...
                      className="min-w-[36px] min-h-[36px] p-1.5 text-slate-400 hover:text-slate-700 rounded-full cursor-pointer flex items-center justify-center -mr-1 transition"
