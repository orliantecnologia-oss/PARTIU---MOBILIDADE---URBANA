    ...
    <>
      ...
      <div className="fixed top-20 inset-x-3 z-40 max-w-sm mx-auto pointer-events-auto animate-in slide-in-from-top duration-300">
        <div className="bg-white/95 backdrop-blur-md rounded-2xl p-3 shadow-lg border border-slate-200/90 text-left space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10.5px] font-black px-2 py-0.5 rounded-full bg-cyan-50 text-[#0088FF] border border-[#00C6FF]/40">
      ...
      >
        ...
        <div className="absolute -top-6 left-1/2 -translate-x-1/2 z-20 pointer-events-none">
          <div className="relative w-12 h-12 rounded-full bg-slate-950 border-[3px] border-[#00C6FF] shadow-xl flex items-center justify-center text-white">
            {categoriaVeiculo === "MOTO" ? (
              <Bike className="w-6 h-6 text-[#00C6FF]" />
            ) : (
              <Car className="w-6 h-6 text-[#00C6FF]" />
            )}
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-slate-200/90 pt-8 p-4 sm:p-5 space-y-3 text-left">
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-extrabold px-2 py-0.5 rounded-full border bg-cyan-50 text-[#003366] border-[#00C6FF]/50">
                    Onda {currentWave}/3
                  </span>
                </div>
                <p className="text-xs text-[#003366] font-semibold mt-0.5 truncate transition-all duration-300">
                  {waveDetails.message}
                </p>
              </div>
            </div>
            ...
            <div className="text-right shrink-0">
              <span className="inline-block px-2.5 py-0.5 rounded-xl bg-slate-100 text-slate-700 text-[10.5px] font-black border border-slate-200/80 shadow-xs">
                {waveDetails.radiusLabel}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-3 p-2.5 rounded-2xl bg-slate-50 border border-slate-200/80">
            ...
            <div className="relative w-10 h-10 shrink-0 flex items-center justify-center">
              ...
              <span className="absolute text-[10.5px] font-black text-[#003366]">
          ...
          <button
            ...
            className="w-full py-2.5 px-4 rounded-2xl bg-white hover:bg-rose-50/50 text-[#EF4444] text-xs font-black transition-all active:scale-[0.99] flex items-center justify-center gap-2 cursor-pointer border border-[#EF4444] shadow-xs"
          >
