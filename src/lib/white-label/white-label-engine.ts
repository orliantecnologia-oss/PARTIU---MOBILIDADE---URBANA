...
export const DEFAULT_WHITELABEL_CONFIG: WhiteLabelFullConfig = {
  ...
  designSystem: {
    paletaPrimaria: {
      corPrincipal: "#FFDE00",
      corPrincipalHover: "#FACC15",
      corSecundaria: "#FA6400",
      corSecundariaHover: "#EA580C",
      corTerciaria: "#0F172A",
  ...
  menuBuilder: {
    itensDrawer: [
      ...
      { id: "m4", rotulo: "Cupons & Descontos", icone: "Tag", rota: "/app", ordem: 4, visivel: true, badge: "Novo", badgeCor: "bg-amber-500 text-slate-950" },
...
export const WHITELABEL_PRESETS: WhiteLabelThemePreset[] = [
  {
    id: "preset-partiu",
    nome: "PARTIU Oficial (Amarelo & Preto)",
    descricao: "Identidade brasileira vibrante com alto contraste e legibilidade solar",
