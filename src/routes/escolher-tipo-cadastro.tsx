  ...
  return (
    <div className="min-h-[100dvh] bg-[#0b0f17] text-white flex flex-col justify-between p-4 sm:p-6 w-full pb-[max(1.5rem,env(safe-area-inset-bottom,0px))]">
      ...
      <div className="mx-auto w-full max-w-md flex items-center justify-between">
        ...
        <span className="text-xs font-black uppercase tracking-wider text-brand-primary-vibrant">
          Criar Nova Conta
        </span>
        <div className="w-11" />
      </div>
      ...
      <div className="w-full max-w-md mx-auto flex-1 flex flex-col justify-center py-6">
        ...
        <div className="text-center mb-7">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-primary-vibrant text-slate-950 shadow-lg shadow-brand-primary-vibrant/20 mb-3">
            <Zap className="h-7 w-7 fill-slate-950 stroke-[2.5]" />
          </div>
          <span className="inline-flex items-center gap-1.5 text-xs font-black text-brand-primary-vibrant uppercase tracking-wider">
        ...
        <div className="space-y-3">
          ...
          <Link
            ...
            className="group flex items-center gap-4 rounded-2xl bg-slate-900/90 hover:bg-slate-900 p-4 border border-slate-800 hover:border-brand-primary-vibrant/60 transition-all active:scale-[0.98] min-h-[76px] cursor-pointer shadow-lg"
          >
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-brand-primary-vibrant text-slate-950 font-black shadow-xs group-hover:scale-105 transition-transform">
            ...
            <ArrowRight className="h-5 w-5 text-slate-500 group-hover:text-brand-primary-vibrant transition-transform group-hover:translate-x-1" />
          </Link>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-slate-400">
            ...
            <Link
              to="/auth"
              search={{ redirect: "/app" }}
              className="text-brand-primary-vibrant font-black hover:underline ml-1"
            >
              Fazer Login
            </Link>
          </p>
