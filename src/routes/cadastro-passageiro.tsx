  ...
  return (
    <div className="min-h-[100dvh] bg-[#0b0f17] text-white flex flex-col justify-between p-4 sm:p-6 w-full pb-[max(1.5rem,env(safe-area-inset-bottom,0px))]">
      ...
      <div className="mx-auto w-full max-w-md flex items-center justify-between">
        ...
        <span className="text-xs font-black uppercase tracking-wider text-brand-primary-vibrant flex items-center gap-1">
      ...
      <main className="w-full max-w-md mx-auto flex-1 flex flex-col justify-center py-4">
        {!sucesso ? (
          ...
          >
            <div className="text-left border-b border-slate-800 pb-3">
              <div className="flex items-center gap-2 mb-1">
                <div className="h-8 w-8 rounded-xl bg-brand-primary-vibrant flex items-center justify-center text-slate-950 font-black">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full h-12 rounded-xl bg-slate-950 px-4 text-sm font-medium text-white outline-none border border-slate-800 focus:border-brand-primary-vibrant transition-colors"
              />
            </div>
            ...
            <div className="rounded-2xl bg-slate-950 p-3.5 border border-slate-800 space-y-2.5">
              <div className="flex items-center gap-2.5">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-brand-primary-vibrant text-slate-950 shrink-0 font-black">
              ...
              <div className="flex items-center justify-between text-xs bg-slate-900 p-2.5 rounded-xl border border-slate-800">
                ...
                <button
                  ...
                  className="text-xs text-slate-950 font-black bg-brand-primary-vibrant hover:brightness-105 px-3 py-1.5 rounded-lg shrink-0 transition-all active:scale-95 cursor-pointer"
                >
            ...
            <div className="flex items-center gap-2 pt-1">
              <input
                ...
                className="h-4 w-4 rounded accent-brand-primary-vibrant cursor-pointer"
              />
              <label
                htmlFor="wppUpdates"
            ...
            <button
              type="submit"
              className="flex min-h-[48px] h-12 w-full items-center justify-center gap-2 rounded-xl bg-brand-primary-vibrant text-sm font-black text-slate-950 shadow-md shadow-brand-primary-vibrant/20 transition-all hover:brightness-105 active:scale-[0.98] mt-2 cursor-pointer"
            >
            ...
            <div className="text-center pt-1">
              ...
              >
                Já tem uma conta? <span className="text-brand-primary-vibrant font-black underline">Fazer login</span>
              </Link>
            </div>
          </form>
        ) : (
          <div className="rounded-3xl bg-slate-900 p-7 text-center shadow-2xl border border-slate-800 space-y-4 animate-in zoom-in-95">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-primary-vibrant text-slate-950 shadow-lg shadow-brand-primary-vibrant/20">
            ...
            <div className="pt-3 space-y-2">
              <Link
                to="/app"
                className="flex h-12 w-full items-center justify-center rounded-xl bg-brand-primary-vibrant text-xs font-black text-slate-950 shadow-md shadow-brand-primary-vibrant/20 hover:brightness-105 transition-all cursor-pointer"
              >
